              ...
              <div className="glass" style={cardStyle}>
                ...
                <div style={infoListStyle}>
                  ...
                  <div style={infoItemStyle}>
                    ...
                    <a href="mailto:contact@yantralegal.com.au" style={valueStyle}>contact@yantralegal.com.au</a>
                  </div>
                  <div style={infoItemStyle}>
          ...
          <div className="container" style={{ maxWidth: '960px' }}>
            <div style={disclaimerBoxStyle}>
              ...
              <p style={{ ...disclaimerTextStyle, marginBottom: 0 }}>
                Yantra Legal is a law firm and registered migration agency operating under the laws of New South Wales, Australia.
              </p>
            </div>
          </div>
        </section>
