...
export const blogPosts: BlogPost[] = [
  {
    title: "Partner Visa Refusal: What Are Your Options?",
    slug: "partner-visa-refusal-options",
    excerpt: "Receiving a partner visa refusal can be devastating, but it does not have to be the end of your migration pathway. Learn about your rights, ART reviews, and strategic options.",
    date: "June 2, 2026",
  ...
  {
    title: "ART Appeals Explained in Simple Terms",
    slug: "art-appeals-explained",
    excerpt: "The Administrative Review Tribunal (ART) replaced the AAT on 14 October 2024. Understand how this new tribunal reviews visa decisions and what to expect during the merits review process.",
    date: "May 25, 2026",
  ...
  {
    title: "Divorce Process in Australia Explained",
    slug: "divorce-process-australia",
    excerpt: "Navigating the end of a marriage is difficult. This guide explains the legal requirements, separation rules, and timelines for obtaining a divorce in Australia under the no-fault system.",
    date: "May 18, 2026",
    category: "Family Law",
    readTime: "6 min read",
    content: [
