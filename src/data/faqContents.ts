// Shared FAQ content — single source of truth for both the public API
// (src/app/api/faqs/route.ts) and server-rendered FAQPage schema
// (src/app/faqs/page.tsx). Seeded into the `faqs` collection on first load.
